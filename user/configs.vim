" coc extensions
let g:coc_global_extensions = ['coc-pyright', 'coc-git', 'coc-tslint-plugin', 'coc-tsserver', 'coc-emmet', 'coc-css', 'coc-html', 'coc-json', 'coc-yank', 'coc-prettier', 'coc-styled-components', 'coc-rust-analyzer', 'coc-clangd']
